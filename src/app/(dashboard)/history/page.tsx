...
import { Card, CardFooter } from "@/components/shared/card";
...
const Page = () => {
  ...
  const [currentImageStyle, setCurrentImageStyle] = useState<string | null>();
  ...
  const openImageViewer = (image: Generation) => {
    if (image.public_url) {
      ...
      setCurrentImageStyle(image.style);
    ...
    <div className="space-y-6 w-full pb-10">
      ...
      {viewerOpen && currentImage && (
        <ImageViewer
          ...
          style={currentImageStyle || undefined}
