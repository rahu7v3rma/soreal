...
import { BlackBadge } from "@/components/shared/black-badge";
...
function Layout({ children }: { children: React.ReactNode }) {
  const { authUser, userProfile, logout, userCredits } = useSupabase();
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className="font-medium">
                      {userCredits?.creditBalance
                        ? userCredits?.creditBalance.toLocaleString()
                        : "0"}{" "}
                      Credits
                    </span>
                  </Link>
