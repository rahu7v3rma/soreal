                  ...
                  >
                    ...
                    <SelectContent>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <SelectItem value="photorealistic, high resolution, 8K, hyperdetailed, professional photography, sharp focus, DSLR, natural lighting, cinematic, HDR">
                              Portrait
                            </SelectItem>
                          </TooltipTrigger>
                          <TooltipContent side="right" className="max-w-sm">
                            <p>
                              Chest or shoulders up, focused on the face. For
                              headshots, profiles, or interviews
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <SelectItem value="cinematic, film grain, dramatic lighting, movie still, professional cinematography">
                              Landscape
                            </SelectItem>
                          </TooltipTrigger>
                          <TooltipContent side="right" className="max-w-sm">
                            <p>
                              Wide view of the full scene. For travel,
                              architecture, or background-focused shots
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
